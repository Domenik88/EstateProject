 ...
 *     uniqueConstraints={
 *          @ORM\UniqueConstraint(name="listing_mls_num_feed_id_state_or_province_idx", columns={"mls_num", "feed_id", "state_or_province"}, options={"where": "state_or_province IS NOT NULL AND mls_num IS NOT NULL AND status = 'live'"}),
