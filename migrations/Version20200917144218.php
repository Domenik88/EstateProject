 ...
 */
final class Version20200917144218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE listing (id INT AUTO_INCREMENT NOT NULL, mls_num VARCHAR(255) NOT NULL, feed_listing_id VARCHAR(255) NOT NULL, feed_id VARCHAR(255) NOT NULL, list_price DOUBLE PRECISION DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, photos_count INT DEFAULT NULL, unparsed_address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
