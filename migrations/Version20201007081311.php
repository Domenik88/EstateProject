 ...
 */
final class Version20201007081311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX listing_mls_num_feed_id_state_or_province_idx ON listing (mls_num, feed_id, state_or_province) WHERE state_or_province IS NOT NULL AND mls_num IS NOT NULL AND status = \'live\'');
    }
